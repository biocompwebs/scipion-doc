...
(RCT) \citep{Radermacher1987a}. In RCT the assumption is that we have
...
get images with low signal-to-noise ratio (SNR). With these two
...
projection images without a priori information (Vargas et al. (2014)).

% TODO: put the proper reference to Vargas et al 2014

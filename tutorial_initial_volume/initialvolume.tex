...
\subsection{Import Tilted Pairs of Micrographs}
...
protocol. In \textit{Pattern untilted} and \textit{Pattern tilted} you
must indicate where your untilted and tilted micrograph files are
...
After we import the micrographs you need to pick tilted and untilted particle pairs.
...
allows you to execute it again if you wish to pick more particles.
...
but you could choose any of the other 2D classification protocol
...
finished you can visualize the classes obtained by clicking on
\keys{Analyze Results}.

These classes show averaged images that represent your particles. But
to be sure that they are representing with fidelity your particle, we
need at least some basic checks:
...
from what the user is looking for.  Each class shows you an average
image that can give you an idea of what you will find if you start a

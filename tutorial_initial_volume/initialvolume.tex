...
\caption{CL2D protocol, with extra options shown by using the
  \textit{expert level}.}
\label{CL2D}
\end{figure}
...
that appears when clicking on \keys{Analyze Result}.
...
% TODO: say you have to right-click on the bad classes and disable
% them, and then click on the \keys{+ Classes} button

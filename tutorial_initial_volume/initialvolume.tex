...
\caption{Xmipp's Random Conical Tilt protocol.}
\label{RCTprotocol}
\end{figure}
...
information.  The \textbf{Thin Object} option must be set to “Yes” if
the particle is not more or less spherical (figure ~\ref{RCTprotocol2}).  When the object is going
...
\caption{Xmipp RCT protocol. Alignment parameters.}
\label{RCTprotocol2}
\end{figure}

...
The \textbf{Thin Object} option must be set to “Yes” if the particle is not more or less spherical (figure ~\ref{RCTprotocol2}) . 
...
\caption{Xmipp RCT protocol. Input parameters.}
\label{RCTprotocol}
\end{figure}

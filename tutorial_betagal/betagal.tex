...
\textbf{NOTE}: The creation of user selected subsets is tracked in \scipion
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{{images/09.CTFProfile}.png}
\caption{Protocol CTFFind output that shows the estimated CTFs for all micrographs.}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{{images/10.CTFFitting}.png}
\caption{Protocol CTFFind output that shows the estimated CTFs for all micrographs.}

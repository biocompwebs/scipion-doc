...
The data will be download in \emph {scipion\_folder/data}.
...
(\emph {\$SCIPION\_HOME/data/tests/rct/micrographs/F\_rct\_u\_*.tif}).

(\emph {\$SCIPION\_HOME/data/tests/rct/micrographs/F\_rct\_t\_*.tif}).
...
(\emph {\$SCIPION\_HOME/data/tests/rct/positions}).

...
Select the set of untilted particles produced by the previous step and  %or the ones on the subset if you chose to remove some of the particles.fill in the rest of the parameters as shown in figure~\ref{CL2D} and press \textbf{Execute}.
...
Be sure you are using the stable core classes. These are composed by those particles that have stayed through all iterations together. 

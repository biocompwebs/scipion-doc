...
To start image processing in Scipion we need to run \scipion from the command line.
For this tutorial we register a new project by clicking the \keys{Create Project}
button and specifying project name. Then we navigate to project window.  

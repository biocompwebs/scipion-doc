...
\menu{refine > projection matching} and choose expert mode.
Input parameters are displayed in Figures \ref{fig:ProjMatchA}, \ref{fig:ProjMatchB},
\ref{fig:ProjMatchC} and \ref{fig:ProjMatchD} . We explain here only... 
For more detail please use parameters \textbf{help} button.
For this tutorial we need to edit:

...
collected at 300 $kV$ and a calibrated magnification of 56,588,  % TODO: check format of number
giving a pixel
...
% TODO: ``MAIN GUI''? Isn't it better ``browser''?
...
information shown in figure (\ref{fig:ProjectGUI}).
...
micrographs. In this example we use the options shown in figure (\ref{fig:Preprocess}).
Please, put the values as same as figure (\ref{fig:Preprocess}).

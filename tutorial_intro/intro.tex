...
you may click on the \textbf{Analyze Results} button (figure
...
finish the selection, press on the \textbf{Micrographs} button to
...
press \verb+OK+. When you finish, press the \textbf{Recalculate CTFs}
button.
...
Once you press the \textbf{Execute} button, several windows will open
...
information. When you are done picking particles press \textbf{Done}
and you will be asked if you want to create the output.  If you choose
\textbf{No}, you can continue picking and the selected particles will
...
micrographs to use and clicking \textbf{Execute}, it will launch the
...
In order to select particles:
  ...
  \begin{itemize}
   \item Use \keys{\shift + mouse wheel} in the overview window to zoom in and out.

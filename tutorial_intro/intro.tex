...
\subsection{Frealign Refinement}
 ...
 that has been processes with projection matching with the features needed
 for frealign.


To do this, the first step is to extract the particles
again, but preprocess particles as shown in Figure \ref{fig:ExtractForFrealign}.
 ...
 Once the particles are extracted, use \menu{Particles > Set operations > union sets}
 to join extracted particles, and in second place

...
you may click on the \textbf{Analyze Result} button (figure
...
create your subset of micrographs with only the ones enabled (figure
(\ref{fig:CTFResult})).
...
CTF of all the micrographs, and different related parameters.}
\label{fig:CTFResult}
\end{figure}
...
You could instead double-click on the \textit{Xmipp manual picking}
protocol. It will launch a window as in figure (\ref{fig:XmippPP}). This

...
\textsc{\large Scipion Tutorial Series}\\[1.0cm] % Minor heading such as course title


\textsc{\LARGE National Center for Biotechnology} \\[0.5cm] % Name of your university/college
